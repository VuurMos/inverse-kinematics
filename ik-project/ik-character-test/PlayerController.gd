...
onready var lleg = $Visuals/Torso/LLeg
onready var rleg = $Visuals/Torso/RLeg
onready var torso = $Visuals/Torso
...
func _physics_process(delta):
	...
	lleg.UpdateIK(_velocity)
	rleg.UpdateIK(_velocity)
	torso.bounce(_velocity)
